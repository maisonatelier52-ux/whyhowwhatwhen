    ...
    <>
      <div className="bg-white text-gray-900 dark:bg-[#020f15] dark:text-gray-100">
        ...
        <article className="prose max-w-4xl mx-auto py-16 px-6 md:px-10 leading-relaxed">
          ...
          <p>
            Welcome to <strong>WhyHowWhatWhen</strong> (“we,” “us,” or “our”). By
          ...
          <p>You may use WhyHowWhatWhen for personal, non-commercial purposes. You agree not to:</p>
          ...
          <p>
            All articles, videos, graphics, photographs, logos, and materials on WhyHowWhatWhen are protected by copyright, trademark, and other intellectual property laws. You may not reproduce or use these materials without express permission.
          </p>
          ...
          <p>
            By submitting comments, messages, or content to WhyHowWhatWhen, you grant us a worldwide, royalty-free, perpetual license to use, publish, and distribute that content. You are responsible for ensuring your submissions are lawful and do not violate others’ rights.
          </p>
          ...
          <p>
            WhyHowWhatWhen strives for accuracy, fairness, and transparency; however, we make no guarantees regarding the completeness, reliability, or timeliness of published content.
          </p>
          ...
          <p>
            Articles covering finance, law, health, or other sensitive topics are for informational purposes only. WhyHowWhatWhen does not provide legal, financial, or medical advice.
          </p>
          ...
          <p>
            Our Services may contain links to external sites. WhyHowWhatWhen does not control or endorse these websites and is not responsible for their content or practices.
          </p>
          ...
          <p>
            WhyHowWhatWhen is not responsible for any damages—including direct, indirect, incidental, or consequential—arising from your use of the Services. Total liability, if any, will not exceed $50 USD.
          </p>
          ...
          <p>
            You agree to indemnify and hold harmless WhyHowWhatWhen, its staff, and affiliates from claims arising from your misuse of the Services or violation of these Terms.
          </p>
          ...
          <p>
            WhyHowWhatWhen may update or modify these Terms at any time. The updated version will be posted on this page with a revised “Last Updated” date. Continued use of the platform constitutes acceptance of the changes.
          </p>
        </article>
      </div>
