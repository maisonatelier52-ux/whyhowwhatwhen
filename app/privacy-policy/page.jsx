      ...
      <div className="bg-white text-gray-900">
        <article className="prose max-w-4xl mx-auto py-16 px-6 md:px-10 leading-relaxed">
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              Websites, apps, and services that link to or integrate with our
              platform
            </li>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Service providers such as hosting, security, and analytics vendors
            </li>
          ...
          <p>
            ...
            personalize content, and deliver relevant ads. Disabling cookies may
          ...
          <p>
            ...
            date indicates the most recent changes. Continued use of our
