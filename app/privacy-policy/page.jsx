    ...
    <>
      ...
      <div className="bg-white text-gray-900 dark:bg-[#020f15] dark:text-gray-100">
        <article className="prose max-w-4xl mx-auto py-16 px-6 md:px-10 leading-relaxed">
          ...
          <p>
            WhyHowWhatWhen collects, uses, distributes, and protects personal information on our U.S.–based digital news platform, including our website, mobile-accessible pages, and any service that links to this Privacy Policy. By using our Services, you agree to this Privacy Policy.
          </p>
          ...
          <p>To exercise these rights, email us at <strong>privacy@WhyHowWhatWhen.com</strong>.</p>
          ...
          <p>WhyHowWhatWhen operates from the United States. If you access our Services from outside the U.S., your data may be processed under U.S. laws.</p>
          ...
          <p>Email: <strong>privacy@WhyHowWhatWhen.com</strong></p>
